    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 mb-3" style="background-color: #EEF1E0; height: 350px;">
                <form method="post" action="/pedagang/{{ $produk->slug }}/pesan/store">
                    <h4 class="pt-3 px-3">Pesanan</h4>
                    @csrf
                    <div class="mb-2 px-3">
                        <label class="form-label" for="jumlah">Jumlah Produk</label>
                        <input class="form-control @error('jumlah') is-invalid @enderror" type="text" id="jumlah" name="jumlah" placeholder="Masukkan jumlah produk">
                        @error('jumlah')
