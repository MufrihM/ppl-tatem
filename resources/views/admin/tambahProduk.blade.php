    ...
    <div class="container-fluid" >
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 mb-3" style="background-color: #EEF1E0; height: 550px;">
                <form method="post" action="/home/produk" enctype="multipart/form-data">
                    <h4 class="pt-3 px-3">Masukkan Produk</h4>
                    @csrf
                    <div class="mb-2 pt-2 px-3">
                        <label class="form-label" for="nama">Nama Produk</label>
                        <input class="form-control @error('nama') is-invalid @enderror" type="text" id="nama" name='nama'placeholder="Masukkan nama produk" value="{{ old('nama') }}">
                        @error('nama')
                    ...
                    <div class="mb-2 px-3">
                        ...
                        <input class="form-control @error('harga') is-invalid @enderror" type="text" id="harga" name="harga" placeholder="Masukkan harga produk" value="{{ old('harga') }}">
                        @error('harga')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
